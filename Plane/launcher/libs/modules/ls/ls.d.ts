...
declare module ls {
    ...
    class Action extends BaseClass {
        ...
        event: AIEvent;
        callTargets: any;
        callTargetBehavior: any;
        isBehaviorExecAction: boolean;
        paramData: any[];
...
declare module ls {
    class Quad {
        ...
        midX(): number;
        midY(): number;
        at(i: number, xory: boolean): number;
        minmax4(a: number, b: number, c: number, d: number): void;
        bounding_box(rc: egret.Rectangle): void;
        ...
        intersects_quad(rhs: Quad): boolean;
    }
}
declare module ls {
    interface QuadChild {
...
declare module ls {
    ...
    class ConditionBlock {
        ...
        private execActionIndex;
        private searchInstances;
        /**
         * 执行动作
         * @param filterinstances 过滤的实例
         */
        execActions(filterinstances: AIObject[]): void;
        execloop(): void;
        execloopLayer(counts: any[], index: number): void;
        execArray(): void;
        execNextAction(): void;
        private execLastActionResult(curresults);
    }
}
declare module ls {
    class Config {
...
declare module ls {
    ...
    class EventSheetDecoder {
        ...
        static decodeFamilyBehaviors(): void;
        static onBehaviorsCreate(): void;
         ...
         * 为了优化性能，解析事件表中参与碰撞的组
         */
        static decodeCollsionFamily(data: any, condition: Condition, targetName: string): void;
...
declare module ls {
    class Layer extends egret.Sprite {
        ...
        add(addValueX: number, addValueY: number): void;
    }
}
declare module ls {
    class LayerManager {
        static layers: any;
        constructor();
        static getLayerByIndex(target: AIObject, index: number): Layer;
        static getIndexByLayer($layer: Layer): number;
        static getLayer($index: number): Layer;
    }
}
declare module ls {
    class LayerVo {
...
declare module ls {
    ...
    class LayoutDecoder {
        ...
        static decodeGlobalBehaviors(instance: AIObject, datas: any): void;
        /**
         * 销毁实例
         */
        static destory(): void;
...
declare module ls {
    class ResCache {
        static configResouces: any;
        static componentResources: any;
    }
}
declare module ls {
...
declare module ls {
    class World {
        ...
        addChildLayerAt($child: AIObject, layerIndex: number, index: number): void;
        addChild($child: AIObject): void;
...
declare module ls {
    class AIDisplayObject extends AIObject {
        ...
        intersects(inst: AIDisplayObject): boolean;
        intersects_rect_off(inst: AIDisplayObject, offsetX: number, offsetY: any): boolean;
        ...
        onCollisionWithOtherObject($event: OnCollisionWithOtherObjectEvent): IConditionData;
        ...
        destoryOnChangeScene(): void;
        /**销毁*/
        destory(destoryModel?: boolean): void;
        saveToJSON(): any;
        loadFromJSON(o: any): void;
         ...
         */
        cloneBehavior(cloneInstance: AIDisplayObject): void;
    }
...
declare module ls {
    class AISprite extends AIDisplayObject {
        ...
        beginGadientFill(type: any, colors: any, alphas: any, radios: any, matrixs: any): void;
        endFill(): void;
        clear(): void;
        lineStyle(thickness: any, color: any, alpha: any, pixelHinting: any, scaleMode: any, caps: any, miterLimit: any): void;
        moveTo(x: any, y: any): void;
        lineTo(x: any, y: any): void;
        drawRect(x: any, y: any, width: any, height: any): void;
        drawCircle(x: any, y: any, radius: any): void;
        drawEllipse(x: any, y: any, width: any, height: any): void;
        drawRoundRect(x: any, y: any, width: any, height: any, ellipseWidth: any, ellipseHeight: any): void;
        drawArc(x: any, y: any, radius: any, startAngle: any, endAngle: any, anticlockwise: any): void;
        curveTo(moveToX: any, moveToY: any, cx1: any, cy1: any, anchorX: any, anchorY: any): void;
        cubicCurveTo(moveToX: any, moveToY: any, cx1: any, cy1: any, cx2: any, cy2: any, anchorX: any, anchorY: any): void;
...
declare module ls {
    class AISystem extends AIObject {
        ...
        pickInstanceEvaluate($event: PickInstanceEvaluateEvent): IConditionData;
        pickInstanceByGUID(event: PickInstanceByGUIDEvent): IConditionData;
        ...
        setLayerBgColorAlpha(layer: any, bgColorAlpha: any): void;
        ...
        layerX(layerIndex: any): number;
        layerY(layerIndex: any): number;
        layerAngle(layerIndex: any): number;
        layerAlpha(layerIndex: any): number;
        layerVisible(layerIndex: any): boolean;
        layerAnchorOffsetX(layerIndex: any): number;
        layerAnchorOffsetY(layerIndex: any): number;
        layerWidth(layerIndex: any): number;
        layerHeight(layerIndex: any): number;
        layerScaleX(layerIndex: any): number;
        layerScaleY(layerIndex: any): number;
        layerParallaxX(layerIndex: any): number;
        layerParallaxY(layerIndex: any): number;
    }
    ...
    class PickInstanceEvaluateEvent extends BaseEvent {
        object: AIObject;
        expression: any;
    }
    class PickInstanceByGUIDEvent extends BaseEvent {
        guid: any;
    }
...
declare module ls {
    ...
    class Trigger {
        ...
        static setConditionStatus(condition: Condition, inst: AIObject, triggerData?: any, changeValue?: any): void;
        static onTrigger(event: TriggerEvent): void;
        static getCollsionStatus(condition: Condition, triggerData: any): boolean;
    }
}
declare module ls {
    class Base64 {
...
declare module ls {
    ...
    class CollisionUtils {
        ...
        static hitTest(lines1: Line[], lines2: Line[]): boolean;
        static simpleLineTest(line1: Line, line2: Line): boolean;
        /**检测矩形1与矩形2是否相交 */
        static intersects_rect(r1: egret.Rectangle, r2: egret.Rectangle): boolean;
        static segments_intersect(a1x: number, a1y: number, a2x: number, a2y: number, b1x: number, b1y: number, b2x: number, b2y: number): boolean;
...
declare module ls {
    ...
    class StartUp {
        ...
        static loadConfig(projectsData: any): void;
