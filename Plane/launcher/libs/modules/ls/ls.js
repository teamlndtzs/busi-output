...
(function (ls) {
    var GameUILayer = (function (_super) {
        ...
        GameUILayer.init = function ($stage) {
            ...
            if (document)
                document.getElementsByClassName("egret-player")[0]["style"].cursor = "default";
        };
...
(function (ls) {
    var SceneCamera = (function () {
        ...
        p.render = function () {
            //先求出有摄像机那层的
            // var cameaLayer: Layer;
            // var otherLayers: Layer[]            = [];
            // var sceneContainer: egret.DisplayObjectContainer = GameUILayer.renderContainer;
            // for (var i: number = 0, len = sceneContainer.numChildren; i < len; i++) {
            //     var layer: Layer                = <Layer>sceneContainer.getChildAt(i);
            //     if (layer.isHasCamera)
            //         cameaLayer                  = layer;
            //     else
